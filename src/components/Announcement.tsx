...
export const Announcement = () => {
  return (
    <div className="bg-secondary/10 py-6 px-4 md:px-6 md:py-8">
      <div className="container mx-auto max-w-6xl">
        <div className="flex items-start gap-3 md:gap-4">
          <Info className="h-5 w-5 text-secondary flex-shrink-0 mt-5 md:mt-7" />
          <p className="text-sm text-foreground/90 leading-relaxed mt-4 md:mt-6">
